var messages = {
  en: {
    nav_menu_doc: "Documentation",
    nav_menu_exam: "Example",
    ...
    page_main: {
      ...
      feature4_title: "3D Models",
      feature4_desc: "Auto-generated 3D Models and point clouds data.",
      feature5_title: "Measurement",
      feature5_desc:
        "Measure distance, area, and volume on maps with 2D/3D control.",
      feature6_title: "Drone flying guidance",
      feature6_desc:
  ...
  th: {
    ...
    page_main: {
      ...
      header_desc:
        "Dronebox ช่วยเพิ่มประสิทธิภาพการประมวลผลภาพโดรนให้ทั้งมือใหม่จนถึงระดับผู้เชี่ยวชาญสามารถจัดการต่อภาพ และแบ่งปันภาพโดรนได้อย่างง่ายและรวดเร็ว",
      tryIt_btn: "ทดลองใช้งานฟรี",
      howIt_header: "การทำงาน",
      howIt1_title: "อัปโหลดภาพ",
      howIt1_desc:
        "อัปโหลดรูปถ่ายที่ได้จากโดรน และไฟล์ GCP (จุดควบคุมภาพถ่าย) เพื่อเพื่มความถูกต้องให้กับภาพ",
      howIt2_title: "ประมวลผลรูปภาพ",
      howIt2_desc: "Dronebox ประมวลผลภาพบนระบบคลาวด์",
      howIt3_title: "วิเคราะห์ผล",
      howIt3_desc:
        "ได้แผนที่ภาพถ่ายทางอากาศ (Orthophoto) แบบจำลองระดับความสูง (DEM) และ Point Cloud แบบ 3 มิติ",
      feature_header: "ความสามารถของ Dronebox",
    ...
    page_about: {
      ...
      partner2_title: "บริษัท แมพพิเดีย จำกัด",
      partner2_desc:
...
var i18n = new VueI18n({
  locale: localStorage.getItem("lang") || "th", // set locale
